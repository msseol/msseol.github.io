...
처음에는 금칙어 관련 처리를 **Elasticsearch**를 사용해서 했던 경험을 메모하고 다른 방안들에 대해서 기록하려 했었다. 그러다 보니 ES 환경을 로컬에 구성했어야 했는데, 한 김에 **Kibana**, **Logstash**, 그리고 **Filebeat**도 같이 구성해 보게 되었다. 개인적으로 정리겸 간단하게 구성해 보았다.
...
해당 파일에는 아래와 같이 3개의 설정 파일을 마운트 해놓은 상태이다.
