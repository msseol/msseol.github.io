...
여간 번거로운 일이 아니었다. 그래서 웹 서비스를 한번 **docker 기반의 환경으로 구동**해보고 나아가서는 <span class="color3">kubernetes를 통해 배포/관리</span> 하는 것을 해보는 것을 목표로 삼아보려고 한다.   
...
<span class="color2">**backend.Dockerfile**</span>
...
<span class="color5"> **COPY** {A} {B} 는 외부(A) 에서 이미지영역(B)으로의 **COPY**를 뜻한다.   
...
<span class="color2">**frontend.Dockerfile**</span>
...
<span class="color2">**.dockerignore**</span>
```
.RData
.Rhistory
.git
...
<span class="color2">**docker-compose.yml**</span>
